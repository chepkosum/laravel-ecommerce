                            ...
                            @if ($product->productColors->count() > 0)
                                ...
                                <div>
                                    @if ($this->prodColorSelectedQuantity == 'outOfStock')
                                        <label class="btn-sm px-2 mt-2  text-white bg-danger">Out of Stock</label>
                                    @elseif($this->prodColorSelectedQuantity > 0)
                                        <label class="btn-sm px-2 mt-2  text-white bg-success ">In Stock</label>
                                    @endif
                                </div>
                            @else
                                @if ($product->quantity)
                                    <label class="btn-sm px-2 text-white bg-success ">In Stock</label>
                                @else
                                    <label class="btn-sm px-2 text-white bg-danger">Out of Stock</label>
                                @endif
                            @endif
                        </div>
                            ...
                            <div class="item mb-3">
                                <div class="product-card">
                                    ...
                                    <div class="product-card-body">
                                        ...
                                        <div>
                                            <span class="selling-price">Ksh
                                                {{ $relatedProductItem->selling_price }}</span>
                                            <span class="original-price">Ksh
                                                {{ $relatedProductItem->original_price }}</span>
                                        </div>
                                    </div>
                                </div>
